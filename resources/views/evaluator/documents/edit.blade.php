                    ...
                    <div class="alert alert-danger">
                        ...
                        <form method="post" action="{{route('document.update',$id)}}">
                            ...
                            <div class="form-group">
                                <input type="text" name="customer_name" class="form-control" value="{{$documents->max_loan}}" placeholder="Maximum Loan amount" />
                            </div>
                            <div class="form-group">
                                <input type="text" name="property_price" class="form-control" value="{{$documents->property_price}}" placeholder="property_price" />
                            </div>
                            <div class="form-group">
                                <input type="text" name="property_price" class="form-control" value="{{$documents->property_type}}" placeholder="property_type" />
                            </div>
                            <div class="form-group">
