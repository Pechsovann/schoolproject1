<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{  url('evaluator/dashboard') }}">
...
{{--                <a class="collapse-item" href="{{ url('admin/utilities/other') }}">Other</a>--}}
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
           aria-expanded="true" aria-controls="collapsePages">
            ...
            <span>Custom Worked</span>
        </a>
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Custom Worked:</h6>
                <a class="collapse-item" href="{{ url('admin/utilities/colors') }}">Table Work</a>
                <a class="collapse-item" href="{{ url('admin/utilities/borders') }}">List end worked </a>
                {{--                <a class="collapse-item" href="{{ url('admin/utilities/animations') }}">Animations</a>--}}
                {{--                <a class="collapse-item" href="{{ url('admin/utilities/other') }}">Other</a>--}}
            </div>
        </div>
    ...
    <!-- Nav Item - Charts -->
    <li class="nav-item">
        <a class="nav-link" href="{{ url('admin/components/charts') }}">
